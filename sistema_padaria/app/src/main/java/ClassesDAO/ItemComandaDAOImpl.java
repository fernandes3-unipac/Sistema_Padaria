...
public class ItemComandaDAOImpl implements ItemComandaDAO {
    ...
    @Override
    public int insertItemComanda(ItemComanda itemComanda) {
         int idGerado = -1;
       try {
        
        PreparedStatement pStatementInsertProducts = conexao.prepareStatement("Insert into TB_Item_Comanda(Quantidade, ValorUnitario, IDComanda, IDProduto) values (?, ?, ?, ?) ", PreparedStatement.RETURN_GENERATED_KEYS);
        pStatementInsertProducts.setDouble(1, itemComanda.getQuantidade());
        pStatementInsertProducts.setDouble(2,itemComanda.getValorUnitario());
        pStatementInsertProducts.setInt(3,2);
        pStatementInsertProducts.setInt(4,itemComanda.getProduto().getIDProduto());
